...
This fork counts Kuma downtime as downtime for every active monitor after restart.
See [Stack downtime behavior, testing and safe deployment](STACK-DOWNTIME.md).
